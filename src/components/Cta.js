          ...
          <div className="relative z-10 lg:col-start-1 lg:row-start-1 lg:col-span-4 lg:py-16 lg:bg-transparent">
            ...
            <div className="max-w-md mx-auto px-4 sm:max-w-3xl sm:px-6 lg:max-w-none lg:p-0">
              <div className="aspect-w-10 aspect-h-6 sm:aspect-w-2 sm:aspect-h-1 lg:aspect-w-1 flex justify-center">
                <img
                  className="relative object-cover object-center rounded-3xl shadow-2xl w-64 md:w-3/5 lg:w-full"
                  src={problem}
                  alt="EstateSync: Problem Solved"
                />
              </div>
            </div>
          </div>
          ...
          <div className="relative bg-sky-700 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
            <div className="hidden absolute inset-0 overflow-hidden rounded-3xl lg:block" aria-hidden="true">
              ...
              >
                <defs>
                  ...
                  >
                    <rect x={0} y={0} width={4} height={4} className="text-sky-800" fill="currentColor" />
                  </pattern>
                </defs>
            ...
            <div className="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
              ...
              <p className="text-lg text-white">
                Ready to help your family remove the frustration and guesswork of estate management?
              </p>
              <a
                className="block w-full py-3 px-5 text-center bg-white border border-transparent rounded-md shadow-md text-base font-medium text-sky-900 hover:bg-gray-50 sm:inline-block sm:w-auto"
