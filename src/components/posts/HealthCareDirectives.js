      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto text-left">
          <p>
            ...
            <br/><br/>Many Americans face questions about medical treatment but may not be capable of making those decisions, for example, in an emergency or at the end of life. This article will explain the types of decisions that may need to be made in such cases and questions you can think about now so you're prepared later. It can help you think about who you would want to make decisions for you if you can't make them yourself. It will also discuss ways you can share your wishes with others. Knowing who you want to make decisions on your behalf and how you would decide might take some of the burden off family and friends.
          </p>
          ...
          <p>
            ...
            <br/><br/>An advance directive also allows you to express your values and desires related to end-of-life care. You might think of it as a living document—one that you can adjust as your situation changes because of new information or a change in your health.
          </p>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 flex justify-center">
            <iframe className="relative rounded shadow-lg w-full aspect-video my-10" src="https://www.youtube.com/embed/syBWjADjBQM" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
          </div>
          <h2>Advance Care Planning Decisions</h2>
          <p>
          ...
          <p>
            ...
            <br/><br/>If you don't have any medical issues now, your family medical history might be a clue to help you think about the future. Talk with your doctor about decisions that might come up if you develop health problems similar to those of other family members.
            <br/><br/>In considering treatment decisions, your personal values are key. Is your main desire to have the most days of life? Or, would your focus be on quality of life, as you see it? What if an illness leaves you paralyzed or in a permanent coma and you need to be on a ventilator? Would you want that?
            <br/><br/>What makes life meaningful to you? If your heart stops or you have trouble breathing, would you want to undergo life-saving measures if it meant that, in the future, you could be well enough to spend time with your family? Would you be content if the emergency leaves you simply able to spend your days listening to books on tape or gazing out the window?
            <br/><br/>But, there are many other scenarios. Here are a few. What would you decide?
          </p>
          <ul role="list">
            <li>If a stroke leaves you unable to move and then your heart stops, would you want CPR? What if you were also mentally impaired by a stroke—does your decision change?</li>
            <li>What if you are in pain at the end of life? Do you want medication to treat the pain, even if it will make you more drowsy and lethargic?</li>
            <li>What if you are permanently unconscious and then develop pneumonia? Would you want antibiotics and to be placed on a ventilator?</li>
          </ul>
          <p>
            ...
            <br/><br/>There are two main elements in an advance directive—a living will and a durable power of attorney for health care. There are also other documents that can supplement your advance directive. You can choose which documents to create, depending on how you want decisions to be made. These documents include:
          </p>
          <ul role="list">
            <li>Living will</li>
            <li>Durable power of attorney for health care</li>
            <li>Other advance care planning documents</li>
          </ul>
          <p>
          ...
          <p>
            ...
            <br/><br/>You can decide how much authority your proxy has over your medical care—whether he or she is entitled to make a wide range of decisions or only a few specific ones. Try not to include guidelines that make it impossible for the proxy to fulfill his or her duties. For example, it's probably not unusual for someone to say in conversation, "I don't want to go to a nursing home," but think carefully about whether you want a restriction like that in your advance directive. Sometimes, for financial or medical reasons, that may be the best choice for you.
            <br/><br/>Of course, check with those you choose as your health care proxy and alternate before you name them officially. Make sure they are comfortable with this responsibility.
          </p>
          <h2>Making Your Health Care Directives Official</h2>
          <p>
            ...
            <br/><br/>Many states have their own advance directive forms. Your <a href='https://eldercare.acl.gov/'>local Area Agency on Aging</a> can help you locate the right forms. You can find your area agency phone number by calling the Eldercare Locator toll-free at <i>1-800-677-1116</i> or by visiting <a href='https://eldercare.acl.gov'>https://eldercare.acl.gov</a>.
            <br/><br/>Some states require your advance directive to be witnessed; a few require your signature to be notarized. A notary is a person licensed by the state to witness signatures. You might find a notary at your bank, post office, or local library, or call your insurance agent. Some notaries charge a fee.
            <br/><br/>Some states have registries that can store your advance directive for quick access by health care providers, your proxy, and anyone else to whom you have given permission. Private firms also will store your advance directive. There may be a fee for storing your form in a registry. If you store your advance directive in a registry and later make changes, you must replace the original with the updated version in the registry.
            <br/><br/>Some people spend a lot of time in more than one state—for example, visiting children and grandchildren. If that's your situation, consider preparing an advance directive using forms for each state—and keep a copy in each place, too.
          </p>
          <h2>What to Do After You Set Up Your Advance Directive</h2>
          <p>
          ...
          <p>
            ...
            <br/><br/><b>Always remember: an advance directive is only used if you are in danger of dying and need certain emergency or special measures to keep you alive, but you are not able to make those decisions on your own. An advance directive allows you to make your wishes about medical treatment known.</b>
            <br/><br/>It is difficult to predict the future with certainty. You may never face a medical situation where you are unable to speak for yourself and make your wishes known. But having an advance directive may give you and those close to you some peace of mind.
          </p>
          <p className="text-base">Source: 
            <a href="https://www.nia.nih.gov/health/advance-care-planning-health-care-directives">National Institute on Aging</a>
          </p>
        </div>
      </div>
    </div>
